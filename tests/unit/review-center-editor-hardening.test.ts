...
lock.release();
assert(lock.acquire('member-add') === true, 'no active mutation -> member-add can start');
assert(lock.acquire('basic') === false, 'member-add active -> basic blocked');
assert(lock.acquire('type-details') === false, 'member-add active -> type details blocked');
assert(lock.acquire('assignments') === false, 'member-add active -> assignments blocked');
assert(lock.acquire('member-remove') === false, 'member-add active -> member-remove blocked');
lock.release();
assert(lock.acquire('member-remove') === true, 'after release -> member-remove can start');
assert(lock.acquire('member-primary') === false, 'member-remove active -> member-primary blocked');
lock.release();
assert(lock.acquire('basic') === true, 'after release -> basic can start');
assert(lock.acquire('member-add') === false, 'basic active -> member-add blocked');
lock.release();
assert(lock.acquire('assignments') === true, 'after release -> assignments can start');
assert(lock.acquire('member-primary') === false, 'assignments active -> member-primary blocked');
lock.release();
